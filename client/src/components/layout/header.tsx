...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-5 left-0 right-0 z-50 px-4 sm:px-6 md:px-8">
        <div className="glass-effect rounded-full py-5 px-6 shadow-xl max-w-screen-xl mx-auto w-full">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          <div
            ...
            onClick={toggleMenu}
          />
          <div className="fixed top-24 left-4 right-4 glass-strong rounded-2xl p-6 shadow-xl mobile-menu-content mt-5">
